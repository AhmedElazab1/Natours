...
// Handle form submit event in the login page
if (loginForm) loginForm.addEventListener('submit', (e)=>{
    // Prevent page from reloading on form submit
    e.preventDefault();
    // Get email & password values from the input fields
...
const bookTour = async (tourId)=>{
    try {
        const stripe = Stripe('pk_test_51SeEhL0goE98o7q84EwLV4dBxV6ZnH8uGjnjt5ncbuWxrnbIwiYlUo7YHZbBGdBxWazaLj8xRnfIbmHFQgFXQOBw00hlYc0tBe');
